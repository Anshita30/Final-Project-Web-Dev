...
<body>
    ...
    <form action="edit_article.php?id=<?php echo $movie_id; ?>" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" id="title" name="title" value="<?php echo htmlspecialchars($movie['title']); ?>" required><br><br>

        <label for="description">Description:</label>
        <textarea id="description" name="description" required><?php echo htmlspecialchars($movie['description']); ?></textarea><br><br>

        <label for="release_year">Release Year:</label>
        <input type="number" id="release_year" name="release_year" min="1900" max="2100" value="<?php echo htmlspecialchars($movie['release_year']); ?>" required><br><br>
        ...
        <input type="number" id="duration" name="duration" min="1" value="<?php echo htmlspecialchars($movie['duration']); ?>" required><br><br>

        <label for="director">Director:</label>
        <input type="text" id="director" name="director" value="<?php echo htmlspecialchars($movie['director'] ?? ''); ?>"><br><br>

        <label for="rating">Rating (0-10):</label>
        <input type="number" id="rating" name="rating" min="0" max="10" step="0.1" value="<?php echo htmlspecialchars($movie['rating'] ?? ''); ?>"><br><br>

        <?php if ($current_image): ?>
            <p>Current Image:</p>
            <img src="<?php echo htmlspecialchars($current_image); ?>" alt="Current Image" style="max-width: 200px;"><br>
            <label>
